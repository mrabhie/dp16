...
#Whatsnew: in this we have redirect funcionaity and how to create utilities.py and also uploading twoimages and displayinng them
...
def home(request):
    return render(request,"dp16app/home.html")



def profile(request):
    name="akshay"
    return render(request,"dp16app/profile.html",{'name':name})
...
def register(request):
    ...
    return render(request,"dp16app/register.html")
...
from django.core.files.storage import FileSystemStorage
from dp16app.utilites import store_image
